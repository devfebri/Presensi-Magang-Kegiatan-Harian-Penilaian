...
@section("js")
    ...
    <script>
        ...
        $("#take-presensi").click(function() {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route("pemagang.presensi.store") }}",
                data: {
                    _token: "{{ csrf_token() }}",
                    image: image,
                    lokasi: lokasi.value,
                ...
                success: function(res) {
                    if (res.status == 200) {
                        ...
                        setTimeout("location.href='{{ route("pemagang.dashboard") }}'", 5000);
