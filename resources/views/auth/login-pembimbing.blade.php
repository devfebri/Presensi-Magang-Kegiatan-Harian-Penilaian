...
<body class="min-h-screen bg-slate-50 font-sans antialiased overflow-x-hidden">
    ...
    <div class="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <div class="absolute top-0 left-1/4 w-80 h-80 bg-purple-300 rounded-full mix-blend-multiply filter blur-[100px] opacity-40 animate-blob"></div>
    ...
    <div class="relative z-10 min-h-screen flex">
        ...
        <div class="hidden lg:flex w-1/2 bg-gradient-to-br from-purple-700 via-brand-600 to-indigo-700 relative overflow-hidden flex-col items-center justify-center p-12">
            <!-- Decorative circles -->
            ...
            <div class="w-full max-w-md">
                ...
                <div class="mb-8">
                    ...
                    <div class="flex items-center gap-3 mb-6 lg:hidden">
                        <div class="w-10 h-10 rounded-xl bg-gradient-to-tr from-purple-600 to-brand-500 flex items-center justify-center shadow-lg">
                    ...
                    <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-50 border border-purple-200 text-purple-600 text-xs font-semibold mb-4">
                ...
                <form action="{{ route('login.pembimbing.auth') }}" method="POST" class="space-y-5">
                    ...
                    <div class="flex items-center justify-between">
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input type="checkbox" name="remember" class="w-4 h-4 rounded border-slate-300 text-purple-600 focus:ring-purple-500 focus:ring-offset-0" />
